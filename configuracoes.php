...
<body>
	...
	<!--Sidebar-->
		<div class="sidebar">
			...
			<a href="extrato.html"><i class="fas fa-receipt" style="padding-left: 3px;"></i><span> Extrato</span></a>
			...
			<a href="configuracoes.html" id="active"><i class="fas fa-cogs"></i><span> Configurações</span></a>
		</div>
