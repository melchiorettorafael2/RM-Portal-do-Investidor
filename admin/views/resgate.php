...
<body style="background-color:#eee;">
	...
	<!--Sidebar-->
		<div class="sidebar">
			...
			<a href="resgate.php" id="active"><i class="fas fa-money-bill-alt"></i><span> Resgate</span></a>
		...
		<div class="form group container-fluid mt-4">
		  <form>
		    <div class="form-group">
		      ...
		      <input type="text" readonly class="form-control bg-white text-dark" id="staticEmail" value="<?php echo $userDetails->name; ?>">
		  </div>
		</div>
		    <div class="form-group">
		      <label for="staticEmail">Disponível:</label>
		      <div class="input-group-prepend">
