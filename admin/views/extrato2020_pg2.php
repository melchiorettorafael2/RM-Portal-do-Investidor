			...
			<div class="row">
				...
				<div class="card text-center">
				  ...
				  <div class="card-body">
				    ...
				    <!--Janeiro-->
				    <h5 class="card-header mb-3" style="background-color: #111;color:white;">MAIO</h5>
				    ...
				    <!--/Janeiro-->
				    <!--Fevereiro-->
				    <h5 class="card-header mb-3" style="background-color: #111;color:white;">JUNHO</h5>
				    <h6 class="card-text text-left">Semana<span class="h6" style="margin-left:150px;">Aporte</span><span class="h6" style="margin-left:150px;">Data</span><span class="h6" style="margin-left:150px;">Extrato</span><span class="h6" style="margin-left:150px;">R$</span><span class="h6" style="margin-left:150px;">Data</span></h6><hr>
				    <!--1ª Semana-->
				    <p class="card-text text-left">1ª Semana<span style="margin-left:150px;">R$</span><span style="margin-left:180px;">-</span><span style="margin-left:150px;">Saldo Inicial</span><span style="margin-left:100px;">R$ 63.775,00</span><span style="margin-left:90px;">01/01/2020</span></h6>
				    	<!--2ª Semana-->
				    ...
				    <!--/Fevereiro-->
				    <!--Março-->
				    <h5 class="card-header mb-3" style="background-color: #111;color:white;">JULHO</h5>
				    <h6 class="card-text text-left">Semana<span class="h6" style="margin-left:150px;">Aporte</span><span class="h6" style="margin-left:150px;">Data</span><span class="h6" style="margin-left:150px;">Extrato</span><span class="h6" style="margin-left:150px;">R$</span><span class="h6" style="margin-left:150px;">Data</span></h6><hr>
				    <!--1ª Semana-->
				    <p class="card-text text-left">1ª Semana<span style="margin-left:150px;">R$</span><span style="margin-left:180px;">-</span><span style="margin-left:150px;">Saldo Inicial</span><span style="margin-left:100px;">R$ 63.775,00</span><span style="margin-left:90px;">01/01/2020</span></h6>
				    	<!--2ª Semana-->
				    ...
				    <!--/Março-->
				     <!--Fevereiro-->
				    <h5 class="card-header mb-3" style="background-color: #111;color:white;">AGOSTO</h5>
				    <h6 class="card-text text-left">Semana<span class="h6" style="margin-left:150px;">Aporte</span><span class="h6" style="margin-left:150px;">Data</span><span class="h6" style="margin-left:150px;">Extrato</span><span class="h6" style="margin-left:150px;">R$</span><span class="h6" style="margin-left:150px;">Data</span></h6><hr>
				    <!--1ª Semana-->
				    <p class="card-text text-left">1ª Semana<span style="margin-left:150px;">R$</span><span style="margin-left:180px;">-</span><span style="margin-left:150px;">Saldo Inicial</span><span style="margin-left:100px;">R$ 63.775,00</span><span style="margin-left:90px;">01/01/2020</span></h6>
				    	<!--2ª Semana-->
				    ...
				    <a href="extrato2020.html" class="btn btn-success float-left"><i class="fas fa-arrow-left"></i></a>
				    <a href="extrato2020_pg3.html" class="btn btn-success float-right"><i class="fas fa-arrow-right"></i></a>
				  </div>
				</div>
