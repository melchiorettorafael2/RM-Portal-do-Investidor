...
$status= 'Em Análise';
 $db = getDB();
       $stmt = $db->prepare("INSERT INTO aporte(email, valor, investidor, data, status, id_user)  VALUES (:email,:valor,:investidor,:data,:status, :id_user)");
...
$mail = new PHPMailer\PHPMailer();
  ...
  $mail->SingleTo = true;
  $mail->From = "noreply@klausinvest.com";
  $mail->FromName = $name;
  $mail->addAddress('contato@klausinvest.com');
  $mail->Subject=("Solicitação de Aporte.");
   ...
   <table border="0" cellpadding="0" cellspacing="0" width="100%">
     ...
     <tr>
      <td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
          Eu,&nbsp;'.$name.' investidor do fundo Klausinvest,<br>gostaria de realizar um aporte no valor de R$ '.$valor.' na data de '.$data.'.
      </td>
     </tr>
     <tr>
      <td>
