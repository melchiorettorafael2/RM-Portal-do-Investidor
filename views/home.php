 ...
 /* Default height for small devices */
   ...
   /* Default height for small devices */
    @media (min-width: 556px){
      ...
      .sidebar{
        background: linear-gradient(0deg, rgba(0,0,0,0.7),rgba(0,0,0,0.7)),url('../img/side8.png'); background-size:cover; background-attachment: fixed; 
        margin-top: 70px; 
        padding: 30px;
        position: fixed;
        margin-left: 0;
    ...
    @media (min-width: 992px) {
      ...
      .sidebar{
        background: linear-gradient(0deg, rgba(0,0,0,0.7),rgba(0,0,0,0.7)),url('../img/side8.png'); background-size:cover; background-attachment: scroll; 
        margin-top: 70px; 
        padding: 30px;
        position: fixed;
        margin-left: 0;
...
<?php } ?>
  ...
  <!--Cabeçalho-->
    ...
    <div class="left_area">
      <label for="check">
      <h3><img src="../img/INVEST5.png" style="width:180px; cursor: pointer;"></h3> 
    </label>
    </div>
  ...
  <!-- Banner -->
      <div class="mb-4 text-center container-fluid" id="banner" style=" background: linear-gradient(0deg, rgba(0,0,0,0.1),rgba(0,0,0,0.1)), url('../img/trade4.png'); background-size: cover;">
  ...
  box-shadow: 10px 10px 5px 0px rgba(0,0,0,0.75); border-radius: 10px;">
    ...
    <?php } else { ?> 
      ...
      <?php } ?> 
        ...
        <blockquote class="blockquote mb-0">
    <?php if ($language ==='en_usa') { ?> 
          <p id="text-comunicados"><img src="../img/pix.png" id="foto_comunicado">&nbsp;&nbsp;&nbsp;Our Pix Key: 304.313.818-01<a class="btn btn-light" title="Copy Pix Key"style="border-radius:20px;" data-clipboard-text="304.313.818-01"><i class="far fa-copy" style="color:#006bdf; border-radius:20px;"></i></a></p>
    <?php } else { ?> 
         <p id="text-comunicados"><img src="../img/pix.png" id="foto_comunicado">&nbsp;&nbsp;&nbsp;Nossa chave Pix: 304.313.818-01<a class="btn btn-light" title="Copiar Chave PIX"style="border-radius:20px;" data-clipboard-text="304.313.818-01"><i class="far fa-copy" style="color:#006bdf; border-radius:20px;"></i></a></p>
