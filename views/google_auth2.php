...
<head>
  ...
  @media (min-width: 360px){
    body{
        	background:linear-gradient(0deg, rgba(0,0,0,0.5), rgba(0,0,0,0.5)),url('../img/google_bg83.png');
        	margin-top:20px;
            zoom:0.48;
         ...
         @media (min-width: 992px){
            body{
             background:linear-gradient(0deg, rgba(0,0,0,0.7), rgba(0,0,0,0.7)),url('../img/google_bg82.png');
               margin-top:-10px; 
               zoom:1;
                background-size: cover;
                display: flex;
         ...
         @media (min-width: 1500px){
                body{
                     background:linear-gradient(0deg, rgba(0,0,0,0.3), rgba(0,0,0,0.3)),url('../img/google_bg82.png');
               padding-top:0px;
               zoom:1.1;
               height: 85vh;
...
<body>
	...
	<?php } else { ?> 
	  ...
	  <h2 class="text-center mt-5 mb-3 text-white">Olá, <?php echo $userDetails->username;?><span>Google Authenticator</span></h2>
