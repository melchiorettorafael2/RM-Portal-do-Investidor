    ...
    <div class="container">
      <div class="card" id="resgate">
        ...
        <div class="form group container-fluid">
                     <form method="POST" id="form" class="needs-validation" action="mail_reinvestir.php" novalidate>
          ...
          <?php } ?>
                            ...
                            <?php } else { ?>    
                             ...
                             <select class="form-control" name="resgate" id="selectOption">
                                <?php if ($language ==='en_usa') { ?> 
                                    ...
                                    <option>Monthly Profitability Rescue</option>
            ...
            <div class="card-body">
                ...
                <?php } else { ?> 
                    ...
                    <p class="h6 text">Todas as transferências serão feitas no horário comercial (das 09:00 às 17:00).</p>
                <?php } ?>
                     ...
                     function reinvestir(){
                        ...
                        var data = document.getElementById('input_data').value;
                            ...
                            if(valorConvert2<=juros){
                                  if(valor!=""){
                                      swal({
                                        title: "Confirmar Reinvestimento?",
                                        text: "Você gostaria de confirmar o reinvestimento no valor de R$ " +valor+ " na data de " +data+ " para a sua conta do fundo Klaus Invest?",
                                        icon: "warning",
                                    ...
                                    .then((willDelete) => {
                                        if (willDelete) {
                                            swal("Reinvestimento Solicitado com Sucesso!", "",{
                                            icon: "success",
                                            button: "OK",
                                            dangerMode: true,
                                });
                               ...
                               swal({
                                  title: "Reinvestimento Cancelado!",
                                  text: "",
                                  icon: "error",
                                  button: "OK",
                                  dangerMode: true,
                                        ...
                                        swal({
                                          title: "Erro de Reinvestimento!",
                                          text: "Informe o valor que você deseja reinvestir.",
                                          icon: "warning",
                                          button: "OK",
                                          dangerMode: true,
                                    })
