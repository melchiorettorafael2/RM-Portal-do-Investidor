				...
				<div class="card text-center">
				  <div class="card-header" style="background-color: #111;">
				    <ul class="nav nav-tabs card-header-tabs">
				      ...
				      <li class="nav-item">
				        <a class="nav-link active" href="extrato2020.php">2020</a>
				      </li>
				      <li class="nav-item">
				        <a class="nav-link text-white" href="extrato2019.php">2019</a>
				      </li>
				      <li class="nav-item">
				        <a class="nav-link text-white" href="extrato2018.php">2018</a>
				      </li>
				    </ul>
				  ...
				  <div class="card-body">
				    ...
				    <h6 class="card-text text-left">Semana<span class="h6" style="margin-left:150px;">Aporte</span><span class="h6" style="margin-left:150px;">Data</span><span class="h6" style="margin-left:140px;">Extrato</span><span class="h6" style="margin-left:350px;">R$</span><span class="h6" style="margin-left:430px;">Data</span></h6><hr>
				    <!--1ª Semana-->
				    <p class="card-text text-left">1ª Semana<span style="margin-left:150px;">R$</span><span style="margin-left:180px;">-</span><span style="margin-left:150px;">Saldo Inicial</span><span style="margin-left:325px;">R$ 63.775,00</span><span style="margin-left:365px;">01/01/2020</span></h6>
				    	<!--2ª Semana-->
				    	<p class="card-text text-left">2ª Semana<span style="margin-left:150px;">R$</span><span style="margin-left:180px;">-</span><span style="margin-left:150px;">Saldo Inicial</span><span style="margin-left:325px;">R$ 63.775,00</span><span style="margin-left:365px;">01/01/2020</span></h6>
				    		<!--3ª Semana-->
				    		<p class="card-text text-left">3ª Semana<span style="margin-left:150px;">R$</span><span style="margin-left:180px;">-</span><span style="margin-left:150px;">Saldo Inicial</span><span style="margin-left:325px;">R$ 63.775,00</span><span style="margin-left:365px;">01/01/2020</span></h6>
				    			<!--4ª Semana-->
				    			<p class="card-text text-left">4ª Semana<span style="margin-left:150px;">R$</span><span style="margin-left:180px;">-</span><span style="margin-left:150px;">Saldo Inicial</span><span style="margin-left:325px;">R$ 63.775,00</span><span style="margin-left:365px;">01/01/2020</span></h6>
				    				<!--5ª Semana-->
				    				<p class="card-text text-left">5ª Semana<span style="margin-left:150px;">R$</span><span style="margin-left:180px;">-</span><span style="margin-left:150px;">Saldo Inicial</span><span style="margin-left:325px;">R$ 63.775,00</span><span style="margin-left:365px;">01/01/2020</span></h6><hr>
				    <!--/Janeiro-->
				    <!--Fevereiro-->
				    ...
				    <!--/Fevereiro-->
				    <!--Março-->
				    <h5 class="card-header mb-3" style="background-color: #111;color:white;">MARÇO</h5>
				    <h6 class="card-text text-left">Semana<span class="h6" style="margin-left:150px;">Aporte</span><span class="h6" style="margin-left:150px;">Data</span><span class="h6" style="margin-left:140px;">Extrato</span><span class="h6" style="margin-left:350px;">R$</span><span class="h6" style="margin-left:430px;">Data</span></h6><hr>
				    <!--1ª Semana-->
				    <p class="card-text text-left">1ª Semana<span style="margin-left:150px;">R$</span><span style="margin-left:180px;">-</span><span style="margin-left:150px;">Saldo Inicial</span><span style="margin-left:325px;">R$ 63.775,00</span><span style="margin-left:365px;">01/01/2020</span></h6>
				    	<!--2ª Semana-->
				    ...
				    <!--/Março-->
				    <!--Abril-->
				    <h5 class="card-header mb-3" style="background-color: #111;color:white;">ABRIL</h5>
				    <h6 class="card-text text-left">Semana<span class="h6" style="margin-left:150px;">Aporte</span><span class="h6" style="margin-left:150px;">Data</span><span class="h6" style="margin-left:140px;">Extrato</span><span class="h6" style="margin-left:350px;">R$</span><span class="h6" style="margin-left:430px;">Data</span></h6><hr>
				    <!--1ª Semana-->
				    <p class="card-text text-left">1ª Semana<span style="margin-left:150px;">R$</span><span style="margin-left:180px;">-</span><span style="margin-left:150px;">Saldo Inicial</span><span style="margin-left:325px;">R$ 63.775,00</span><span style="margin-left:365px;">01/01/2020</span></h6>
				    	<!--2ª Semana-->
				    ...
				    <a href="#" class="btn btn-success">Imprimir</a>
				     <a href="extrato2020_pg2.html" class="btn btn-success float-right"><i class="fas fa-arrow-right"></i></a>
				  </div>
				</div>
