...
<body>
	...
	<div class="content" style="background-color: #ddd;">
		<div class="container-fluid">
				...
				<div class="card text-center">
				  <div class="card-header" style="background-color: #111;">
				    <ul class="nav nav-tabs card-header-tabs">
				      <li class="nav-item">
				        <a class="nav-link active" href="extrato.html">2021</a>
				      </li>
				      <li class="nav-item">
				        <a class="nav-link text-white" href="extrato2020.html">2020</a>
				      </li>
				      <li class="nav-item">
				  ...
				  <div class="card-body">
				    <h5 class="card-title">EXTRATO DE RENTABILIDADE</h5><hr>
				    ...
				    <h6 class="card-text text-left">Semana<span class="h6" style="margin-left:150px;">Aporte</span><span class="h6" style="margin-left:150px;">Data</span><span class="h6" style="margin-left:150px;">Extrato</span><span class="h6" style="margin-left:150px;">R$</span><span class="h6" style="margin-left:150px;">Data</span></h6><hr>
				    <!--1ª Semana-->
				    <p class="card-text text-left">1ª Semana<span style="margin-left:150px;">R$</span><span style="margin-left:180px;">-</span><span style="margin-left:150px;">Saldo Inicial</span><span style="margin-left:100px;">R$ 63.775,00</span><span style="margin-left:90px;">01/01/2020</span></h6><hr>
			...
			<div class="row" style="background-color: #ddd; padding-top: 5%;">
