 ...
 /* Height for devices larger than 992px */
    ...
    .left_area h3{
     ...
     @media (min-width: 1700px) {
      ...
      .sidebar{
        background: linear-gradient(0deg, rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url('../img/side8.png'); background-size:cover; background-attachment: scroll; 
        margin-top: 70px; 
        position: fixed;
        margin-left: 0;
        left:0;
                      ...
                      datasets: [
                          {
                              ...
                              data: [<?php echo (($valor_base + $rentabilidade)  * $klaus_jan);?>, <?php echo (($valor_base + $rentabilidade) * $klaus_fev);?>, <?php echo (($valor_base + $rentabilidade) * $klaus_mar);?>, <?php echo (($valor_base + $rentabilidade) * $klaus_abr);?>, <?php echo (($valor_base + $rentabilidade) * $klaus_mai);?>, <?php echo (($valor_base + $rentabilidade) * $klaus_jun);?>, <?php echo (($valor_base + $rentabilidade) * $klaus_jul);?>,<?php echo (($valor_base + $rentabilidade) * $klaus_ago);?>, <?php echo (($valor_base + $rentabilidade) * $klaus_set);?>, <?php echo (($valor_base + $rentabilidade)* $klaus_out);?>, <?php echo (($valor_base + $rentabilidade) * $klaus_nov);?>, <?php echo (($valor_base + $rentabilidade)* $klaus_dez);?>]
                          }, {
                            label: 'Selic/CDI',
                            ...
                            borderWidth: 1,
                            barThickness: 11,
                            data: [<?php echo (($valor_base + $rentabilidade)  *$selic_jan);?>, <?php echo (($valor_base + $rentabilidade)* $selic_fev);?>, <?php echo (($valor_base + $rentabilidade) * $selic_mar);?>, <?php echo (($valor_base + $rentabilidade) *$selic_abr);?>, <?php echo (($valor_base + $rentabilidade) * $selic_mai);?>, <?php echo (($valor_base + $rentabilidade) *$selic_jun);?>, <?php echo (($valor_base + $rentabilidade) *$selic_jul);?>,<?php echo (($valor_base + $rentabilidade) *$selic_ago);?>, <?php echo (($valor_base + $rentabilidade) * $selic_set);?>, <?php echo (($valor_base + $rentabilidade) *$selic_out);?>, <?php echo (($valor_base + $rentabilidade) *$selic_nov);?>, <?php echo (($valor_base + $rentabilidade) *$selic_dez);?>]
                          }, {
                            label: 'Poupança',
                            ...
                            borderWidth: 1,
                            barThickness: 11,
                            data: [<?php echo ($valor_base + $rentabilidade) *$poup_jan;?>, <?php echo ($valor_base + $rentabilidade)* $poup_fev;?>, <?php echo ($valor_base + $rentabilidade) * $poup_mar;?>, <?php echo ($valor_base + $rentabilidade) *$poup_abr;?>, <?php echo ($valor_base + $rentabilidade) * $poup_mai;?>, <?php echo ($valor_base + $rentabilidade)*$poup_jun;?>, <?php echo ($valor_base + $rentabilidade) *$poup_jul;?>,<?php echo ($valor_base + $rentabilidade) *$poup_ago;?>, <?php echo $valor_base * $poup_set;?>, <?php echo ($valor_base + $rentabilidade) *$poup_out;?>, <?php echo ($valor_base + $rentabilidade)*$poup_nov;?>, <?php echo ($valor_base + $rentabilidade) *$poup_dez;?>]
                          }]
                  };
                  var options = {
