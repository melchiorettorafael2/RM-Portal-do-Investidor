  ...
  <style type="text/css">
   ...
   /* Default height for small devices */
    @media (min-width: 556px){
      ...
      .sidebar{
        background: linear-gradient(0deg, rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url('../img/side8.png'); background-size:cover; background-attachment: fixed; 
        margin-top: 70px; 
        padding: 30px;
        position: fixed;
        margin-left: 0;
    ...
    <div class="container">
      <div class="card" id="resgate">
        <div class="card-header">
           <?php if ($language ==='en_usa') { ?> 
                <h3><i class="fas fa-money-bill-wave"></i>&nbsp;&nbsp;Rescue</h3>
            <?php } else { ?>
                <h3><i class="fas fa-money-bill-wave"></i>&nbsp;&nbsp;Resgate</h3>
            <?php } ?>
        </div>
        <div class="form group container-fluid">
            ...
            <div class="card-body">
                ...
                <?php } ?>
                 <a href='https://youtu.be/nkry23xAwbY' target='blank'>Dúvidas sobre como realizar o seu resgate? Clique aqui e assista o nosso vídeo explicativo.</a>
                     ...
                     if(saldo>=valorConvert2){ 
                        if(valor !="" && data !="" && valorConvert2>0){
                          swal({
                            ...
                            text: "Would you like to confirm the request for rescue in the amount of R$ " +valor+ " on date" +data_br+ " to your bank account registered in the klaus Invest investment fund?",
                            icon: "warning",
                     ...
                     if(saldo>=valorConvert2){ 
                        if(valor !="" && data !="" && valorConvert2>0){
                          swal({
                            ...
                            text: "Você gostaria de confirmar a solicitação de Resgate no valor de R$ " +valor+ " na data " +data_br+ " para a sua conta bancária cadastrada no fundo de investimento klausinvest?",
                            icon: "warning",
